  ...
  return (
    <div className='flex items-center justify-center flex-col h-screen'>
      <section className='flex items-center justify-center flex-col h-screen gap-2'>
        <div className='flex items-center border p-4 rounded-full mb-4 gap-1 bg-green-100 text-green-800 shadow-sm'>
        ...
        <h1 className='text-3xl md:text-6xl bg-linear-to-r from-green-500 via-emerald-500 to-teal-500 px-4 p-3 rounded-md text-white text-center mb-8'>
          your Productivity!
        </h1>
